        ...
        <div>
            ...
            <div className='project'>
                ...
                <div className='proj-item'>
                    <Link id='proj-img' to='http://piratestore.netlify.app' target='_blank'>  <img  src='./images/pirate.png' alt='...'></img></Link>
                    <Link id='proj-img' to='http://osm-mosam.netlify.app' target='_blank'>  <img src='./images/mosam.png' alt='...'></img></Link>
                    <Link id='proj-img' to='http://icey-food.netlify.app' target='_blank'>  <img src='./images/iceweb.png' alt='...'></img></Link>

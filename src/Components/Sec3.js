        ...
        <div>
            ...
            <div className='sec3-text'>
                ...
                <div className='proj-item'>
                    <img className='proj-img' src='./images/mypage.png' alt='...'></img>
                    <img src='./images/iceweb.png' alt='...'></img>
                    <img src='./images/mosam.png' alt='...'></img>
                    <img src='./images/pirate.png' alt='...'></img>
